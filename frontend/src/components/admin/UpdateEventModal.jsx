...
export default function UpdateEventModal({ event, onClose }) {
  ...
  const submit = async (e) => {
    ...
    try {
      ...
      if (!res.ok) throw new Error("Hiba történt az esemény frissítése során.");
        ...
        <form onSubmit={submit} className="space-y-5">
          <div className="space-y-1">
            ...
            <input
              ...
              className="w-full p-3 rounded-lg border border-[var(--ruby-red)]/30 
                focus:ring-2 focus:ring-[var(--ruby-red)]/40 outline-none transition"
            />
          </div>
          ...
          <div className="space-y-1">
            ...
            <textarea
              ...
              className="w-full p-3 rounded-lg border border-[var(--ruby-red)]/30 
                focus:ring-2 focus:ring-[var(--ruby-red)]/40 outline-none resize-none transition"
            ></textarea>
          </div>
